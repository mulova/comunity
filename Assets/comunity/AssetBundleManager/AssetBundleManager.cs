...
namespace AssetBundles
{
    ...
    public class AssetBundleManager : MonoBehaviour
    {
        ...
        private static void Log(LogType logType, string format, params object[] param)
        {
            string text = param != null ? string.Format(format, param): format;
        ...
        public static void SetDevelopmentAssetBundleServer()
        {
            ...
            {
                Log(LogType.Error, "[AssetBundleManager] Development Server URL could not be found.");
            }
            else
            {
        ...
        {
#if UNITY_EDITOR
            Log(LogType.Info, "[AssetBundleManager] Simulation Mode: {0}", (SimulateAssetBundleInEditor ? "Enabled" : "Disabled"));
#endif
        ...
        {
            Log(LogType.Info, "[AssetBundleManager] Loading Asset Bundle {0}{1}", (isLoadingAssetBundleManifest ? "Manifest: " : ": "), assetBundleName);
            ...
            if (!isLoadingAssetBundleManifest)
            {
                ...
                {
                    Log(LogType.Error, "[AssetBundleManager] Please initialize AssetBundleManifest by calling AssetBundleManager.Initialize()");
                    return;
                }
            }
        ...
        static protected string RemapVariantName(string assetBundleName)
        {
            ...
            {
                Log(LogType.Warning, "[AssetBundleManager] Ambigious asset bundle variant chosen because there was no matching active variant: {0}", bundlesWithVariant[bestFitIndex]);
            }
        ...
        static protected bool LoadAssetBundleInternal(string assetBundleName, bool isLoadingAssetBundleManifest)
        {
            ...
            if (bundleBaseDownloadingURL.ToLower().StartsWith("odr://"))
            {
                ...
                Log(LogType.Info, "[AssetBundleManager] Requesting bundle {0} through ODR", assetBundleName);
            ...
            {
#if ENABLE_IOS_APP_SLICING
                Log(LogType.Info, "[AssetBundleManager] Requesting bundle {0} through asset catalog", assetBundleName);
        ...
        static protected void UnloadAssetBundleInternal(string assetBundleName)
        {
            ...
            if (--bundle.m_ReferencedCount == 0)
            {
                ...
                Log(LogType.Info, "[AssetBundleManager] {0} has been unloaded successfully", assetBundleName);
            }
        }
        ...
        {
            Log(LogType.Info, "[AssetBundleManager] Loading {0} from {1} bundle", assetName, assetBundleName);
            ...
            if (SimulateAssetBundleInEditor)
            {
                ...
                {
                    Log(LogType.Error, "[AssetBundleManager] There is no asset with name \"{0}\" in {1}", assetName, assetBundleName);
                    return null;
                }
        ...
        {
            Log(LogType.Info, "[AssetBundleManager] Loading {0} from {1} bundle", levelName, assetBundleName);
